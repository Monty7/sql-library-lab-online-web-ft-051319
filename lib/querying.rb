...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN characters ON series.id = characters.series_id GROUP BY HAVING characters.species = 'human' ORDER BY COUNT(characters.species);"
end
